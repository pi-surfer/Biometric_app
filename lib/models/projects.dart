...
List<Projects> getProject() {
  ...
  farms.add(Projects(
    ...
    phrase:
        "Production and sale of organic honey. Our bees feed from mountain flowers and plants that give a unique taste to our honey produced with great care and passion. Come and taste it",
  ...
  farms.add(Projects(
    ...
    phrase:
        "Our radicchio rosso tardivo is produced by planting in open fields. The processing is very complex but the result unique. 50 years of experience",
  ...
  farms.add(Projects(
    ...
    phrase:
        "Organic artichoke production, hand-harvested from March. Come visit our store, we offer many other fruits and vegetables",
  ...
  farms.add(Projects(
    ...
    phrase:
        "Are you looking for a zucchini producer and supplier? Come visit us! Since 2005, we have specialized in the production of zucchini, hand-picked and high quality",
  ...
  farms.add(Projects(
    ...
    phrase:
        "Every day on the table with freshness, taste and crispness. We take care of everything from growing to packing. Any type of salad from the local area",
  ...
  int getSelectedProject() {
    ...
    for (i in ids) {
      if (proj[i].light) {
        ...
        debugPrint('no project selected');
        null;
      }
    }
    return idSelected;
